...
if(!["972946320287469628"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
const vmuterol = message.guild.roles.cache.find(r => r.id === '972946383420137594')//Muteli rolü
