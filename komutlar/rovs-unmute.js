...
const mutelog = message.guild.channels.cache.find(c => c.id === '972946602073419826')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '972946380064702575')//Muteli rolü
